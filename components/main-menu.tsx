...
interface MainMenuProps {
  onStartGame: (difficulty: "easy" | "hard" | "extra-hard") => void;
}

export default function MainMenu({ onStartGame }: MainMenuProps) {
  const [selectedDifficulty, setSelectedDifficulty] = useState<
    "easy" | "hard" | "extra-hard" | null
  >(null);
  ...
  const handleDifficultySelect = (
    ...
    // Smooth scroll to the start button after a short delay
    setTimeout(() => {
      const startButton = document.getElementById("start-puzzle-button");
      if (startButton) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Follow the clue to transform the word
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Make 5 transformations to finish
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              >
                <CardHeader className="pb-3">
                  ...
                  <CardDescription>
                    Common words and straightforward clues. Perfect for
                    beginners!
                  </CardDescription>
                </CardHeader>
              ...
              <Card
                className={`cursor-pointer transition-all hover:shadow-md ${
                  selectedDifficulty === "extra-hard"
                    ? "ring-2 ring-purple-500 bg-purple-50 dark:bg-purple-900/20"
                    : "hover:bg-muted/50"
                }`}
                onClick={() => handleDifficultySelect("extra-hard")}
              >
                <CardHeader className="pb-3">
                  <CardTitle className="text-lg flex items-center gap-2">
                  ...
                  <CardDescription>
                    Variable word lengths and multiple letter changes. For true
                    word masters!
                  </CardDescription>
                </CardHeader>
                <CardContent className="pt-0">
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• 5-7 letter words</li>
                    <li>• 2-3 letter changes</li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              ...
              <h3 className="font-semibold">Three Difficulties</h3>
              <p className="text-xs text-muted-foreground">
                Easy, hard, and extra hard
              </p>
            </CardContent>
          </Card>
        </div>
