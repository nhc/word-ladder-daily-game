...
const VALID_WORDS = new Set([
  ...
  'album', 'alert', 'alien', 'align', 'alike', 'alive', 'allow', 'alone', 'along', 'alter',
  'among', 'anger', 'angle', 'angry', 'apart', 'apple', 'apply', 'arena', 'argue', 'arise',
  'array', 'aside', 'asset', 'avoid', 'awake', 'award', 'aware', 'badly', 'baker', 'bases',
  'basic', 'beach', 'began', 'begin', 'being', 'below', 'bench', 'billy', 'birth', 'black',
  ...
  'fluid', 'focus', 'force', 'forth', 'forum', 'found', 'frame', 'frank', 'fraud', 'fresh',
  ...
  'ratio', 'reach', 'ready', 'realm', 'rebel', 'refer', 'right', 'rival', 'river', 'robin',
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!word || !expectedWord) {
      return NextResponse.json({ error: 'Word and expected word are required' }, { status: 400 })
    }
